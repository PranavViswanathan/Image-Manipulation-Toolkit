...
/**
 * The {@code ImageMaskingFiltering} interface extends {@code FilteringOperationEnhanced}
 * and provides methods to apply various image filtering effects with masking functionality.
 * Each method uses a source image and a mask image to determine which parts of the image
...
public interface ImageMaskingFiltering extends FilteringOperationEnhanced {
   ...
   * @param maskImage   the mask {@code ImageRepresentation} defining the regions to apply the effect.
